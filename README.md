...
42 server owns the Bandits 2 NPC, its movement and world actions; the Python
...
- `.03` (`192.168.0.3`): dedicated PZ server, existing save, GoblinSurvivor,
  and the Bandits 2 Workshop package.
...
semantic targets locally before calling the verified Bandits adapter. Unknown
Bandits capabilities fail closed.
