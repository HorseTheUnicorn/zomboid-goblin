...
class QwenClient:
    ...
    def _system_prompt() -> str:
        return (
            ...
            "ammunition. While FOLLOW is active, deterministic game code automatically engages nearby zombies "
            "with the shotgun and then resumes one-tile bodyguard spacing after the threat is dead. Goblin wears "
            ...
            "transfer, base delivery, cooldowns, spawning, persistence, and autonomous chores. When the owner has "
            "not moved for about two minutes, deterministic game code may make Goblin defend the area, barricade "
            "windows or doors when materials are available, craft useful items, scavenge, and return supplies to "
            "base. Do not invent completed work; react to telemetry about what actually happened. Personality "
